...
void pybind_registration_classes(py::module &m) {
    // cupoc.registration.ICPConvergenceCriteria
    ...
    // cupoc.registration.TransformationEstimation
    py::class_<
            registration::TransformationEstimation,
    ...
    // cupoc.registration.TransformationEstimationPointToPoint:
    ...
    // cupoc.registration.RegistrationResult
