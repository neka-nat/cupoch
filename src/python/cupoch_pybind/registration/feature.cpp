...
void pybind_feature(py::module &m) {
    py::class_<wrapper::device_vector_vector33f, std::shared_ptr<wrapper::device_vector_vector33f>>
             dev_vec33(m, "Vector33fVector", "utility::device_vector<Eigen::Matrix<float, 33, 1>>");
    ...
    py::class_<registration::Feature<33>, std::shared_ptr<registration::Feature<33>>>
    ...
    feature.def("resize", &registration::Feature<33>::Resize, "n"_a,
            ...
            .def_property("data", [] (registration::Feature<33> &ft) {return wrapper::device_vector_vector33f(ft.data_);},
                                  [] (registration::Feature<33> &ft, const wrapper::device_vector_vector33f& vec) {wrapper::FromWrapper(ft.data_, vec);},
