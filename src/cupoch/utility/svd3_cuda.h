...
__host__ __device__ __forceinline__ void condNegSwap(bool c,
                                                     float &X,
                                                     float &Y) {
...
__host__ __device__ __forceinline__ void multAB(float a11,
                                                float a12,
                                                float a13,
                                                float a21,
                                                float a22,
...
__host__ __device__ __forceinline__ void multAtB(float a11,
                                                 float a12,
                                                 float a13,
                                                 float a21,
                                                 float a22,
...
__host__ __device__ __forceinline__ void QRGivensQuaternion(float a1,
                                                            float a2,
                                                            float &ch,
                                                            float &sh) {
...
/// A = UP
__host__ __device__ __forceinline__ void pd(float a11,
                                            float a12,
                                            float a13,
                                            float a21,
                                            float a22,
