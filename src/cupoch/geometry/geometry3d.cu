...
Eigen::Vector3f Geometry3D::ComputeMinBound(const utility::device_vector<Eigen::Vector3f>& points) const {
...
void Geometry3D::ResizeAndPaintUniformColor(utility::device_vector<Eigen::Vector3f>& colors,
    const size_t size,
