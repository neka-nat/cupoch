...
pinhole_camera_intrinsic_cpu = o3d.io.read_pinhole_camera_intrinsic("../../testdata/camera_primesense.json")
...
pinhole_camera_intrinsic_gpu = cph.io.read_pinhole_camera_intrinsic("../../testdata/camera_primesense.json")
...
source_rgbd_image_cpu = o3d.geometry.RGBDImage.create_from_color_and_depth(source_color_cpu, source_depth_cpu)
target_rgbd_image_cpu = o3d.geometry.RGBDImage.create_from_color_and_depth(target_color_cpu, target_depth_cpu)
target_pcd_cpu = o3d.geometry.PointCloud.create_from_rgbd_image(target_rgbd_image_cpu, pinhole_camera_intrinsic_cpu)
option_cpu = o3d.odometry.OdometryOption()

source_rgbd_image_gpu = cph.geometry.RGBDImage.create_from_color_and_depth(source_color_gpu, source_depth_gpu)
target_rgbd_image_gpu = cph.geometry.RGBDImage.create_from_color_and_depth(target_color_gpu, target_depth_gpu)
target_pcd_gpu = cph.geometry.PointCloud.create_from_rgbd_image(target_rgbd_image_gpu, pinhole_camera_intrinsic_gpu)
...
_, tc = measure_time(
    ...
    "CPU",
    source_rgbd_image_cpu,
    target_rgbd_image_cpu,
    pinhole_camera_intrinsic_cpu,
    odo_init,
...
_, tg = measure_time(
    ...
    "compute_rgbd_odometry",
    "GPU",
    source_rgbd_image_gpu,
    target_rgbd_image_gpu,
    pinhole_camera_intrinsic_gpu,
    odo_init,
